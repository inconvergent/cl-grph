...
```
 ...
 ;   Derived type: (FUNCTION (T T &OPTIONAL (SIMPLE-ARRAY LIST))
...
:missing:
 ...
 ; 2VFX names a macro:
 ;   Lambda-list: (V)
 ;   Source file: /home/anders/x/grph/src/xgrph-cycle.lisp
```
...
```
 ...
 ;   Source file: /home/anders/x/grph/src/xgrph-triangulate.lisp
```
